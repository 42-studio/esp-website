<template>
  ...
  <div class="grow inline-flex items-center text-right lg:max-w-6xl mb-12">

    <div class="grow pl-4 pr-8 space-y-4">

      <blockquote>
        <p class="md:text-lg md:font-medium">
          <slot />
        </p>
      </blockquote>
