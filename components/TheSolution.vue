...
<template>
  ...
  <div class="relative -mt-4 lg:mt-8">
    ...
    <div class="w-8/12 lg:w-6/12 mx-auto text-center">
      ...
      <p class="my-8 text-lg text-justify leading-8 text-slate-300">
        Our mission is to empower enterprises to improve security coverage and ROI through threat-centric data insights.
      </p>
