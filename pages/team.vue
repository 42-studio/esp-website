<template>
  ...
  <div class="relative mt-[15vh]">

    <div class="container flex flex-wrap mb-20">
    ...
    <div class="container-extended">
      ...
      <div class="block xl:flex items-center">
        ...
        <elements-team-member name="Louis Holt" title="CEO & Co-Founder" photo="louis-holt.jpg" linkedin="https://www.linkedin.com/in/louis-holt">
          Over a decade of cyber security experience across government and enterprise. Louis specialised in security
          value realisation, helping enterprise clients architect, deploy &amp; operationalise security products
