<template>
  ...
  <div class="container relative mt-[15vh]">
    ...
    <div class="flex flex-col lg:flex-row">
      ...
      <div class="w-full lg:w-6/12 lg:pr-10">
      ...
      <div class="flex flex-col w-full lg:w-6/12 lg:pl-10 mb-20">

        <svg class="mx-auto breath-slate px-40 lg:px-20 mt-20 lg:mt-0" width="100%" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/"
        ...
        <div class="w-0.5 h-[5vh] mx-auto my-10 bg-linear-v-gradient" />
