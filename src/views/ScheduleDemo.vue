<template>
  ...
  <esp-background image="backgrounds/fibre.jpg" class="section-content padded schedule-demo">
          ...
          <div class="swapper" :class="{ 'swapped': form.success }">
            ...
            <div class="swap-to">
              ...
              <p class="text-center">
                ...
                A representative should reach out to you within 14 hours to arrange the most suitable time for a
                demonstration.
              </p>

              <p>To ensure you are able receive correspondence, whitelist our domain <strong>esprofiler.com</strong></p>
              ...
              <b-col>
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-input v-model="form.input.firstName" :state="form.error.state('firstName')"/>
              ...
              <b-col>
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-input v-model="form.input.email" :state="form.error.state('email')"/>
              ...
              <b-col>
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-input v-model="form.input.phoneNumber" :state="form.error.state('phoneNumber')"/>
              ...
              <b-col>
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-input v-model="form.input.companyName" :state="form.error.state('companyName')"/>
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-select v-model="form.input.companySize" :options="companySizes"
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-select v-model="form.input.country" :options="countries"
              ...
              <b-col>
                ...
                <label class="w-100">
                  ...
                  <b-input-group class="mt-2">
                    ...
                    <b-form-textarea v-model="form.input.comments" :state="form.error.state('comments')" rows="9"
                                     no-resize
                    />
            ...
            <b-row>
              ...
              <b-col class="d-flex flex-column" style="justify-content: flex-end">
              ...
              <b-col class="d-flex flex-column" style="align-items: flex-end">
                ...
                <b-button type="submit" :variant="condition.state" :disabled="form.loading" class="swapper"
